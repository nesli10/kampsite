                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-1" aria-controls="submenu-1"><i
                                        class="fa fa-fw fa-user-circle"></i>Kamp Alanları <span
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Ekle Güncelle </h2>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url('addcamp') }}" enctype="multipart/form-data">
                                <div class="form-group">
                                    @csrf

                                    <input type="hidden" id="kampid" value="">
                                    <label for="inputUserName">Kamp Alanı İsmi</label>
                                    <input id="kampadi" type="text" name="kampadi" data-parsley-trigger="change"
                                        placeholder="İsim Girin" autocomplete="off" class="form-control" value="">
                                </div>
                                <div class="form-group">
                                    <label for="inputUserName">açıklama</label>
                                     <textarea  id="aciklama" type="textarea" name="aciklama" data-parsley-trigger="change"
                                        placeholder="açıklama " autocomplete="off" class="form-control" value=""> </textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9 col-lg-10">
                                        <input id="link" name="link" type="text" data-parsley-type="url"
                                            placeholder="link" class="form-control" value="">
                                    </div>
                                </div>
