                                ...
                                <div class="destination">
                                    ...
                                    <div class="text p-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="two">
                                                <span class="price per-price">
                                                    ₺{{ $value->ucret }}<br><small>/night</small></span>
                                            </div>
                                        </div>
                                        ...
                                        <p class="bottom-area d-flex">
                                            ...
                                            <span class="ml-auto"><a href="{{ $value->link }}">
                                                    göster</a></span>
                                        ...
                                        @if (!empty($loginedUser))
                                            <form method="post" action="{{ url('addpuan') }}" class="star-rating">
                                                ...
                                                <div class="form-group">
                                                    @csrf
                                                    <input type="hidden" name="kampid" id="kampid"
                                                        value="{{ $value->kampid }}">
                                                    <label for="inputUserName">puan</label>
                                                    <input id="puan" type="text" name="puan"
                                                        data-parsley-trigger="change" placeholder="puan Girin"
                                                        autocomplete="off" class="form-control" value="">
                                                </div>

                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-danger" name="addpuan"
